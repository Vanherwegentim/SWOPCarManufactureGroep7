//todo remove USE CASE doesnt exist anymore
...
//    orderNewCarController.placeCarOrder(0, "BREAK", "BLACK", "PERFORMANCE", "FIVE_SPEED_MANUAL", "LEATHER_BLACK", "AUTOMATIC", "COMFORT", "LOW");
...
//
//    List<String> blockingWorkPosts = assemblyLineController.moveAssemblyLine(60);
//    assertEquals(blockingWorkPosts.get(0), "Car Body Post");
//  }
//
//}
