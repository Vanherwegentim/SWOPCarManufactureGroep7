//todo ward fixt dit vandaag nog
...
//    Map<Integer, String> workPosts = performAssemblyTasksController.giveAllWorkPosts();
//
//    performAssemblyTasksController.moveAssemblyLine(0);
//
